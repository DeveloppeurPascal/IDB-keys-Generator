(* C2PP
  ...
  ***************************************************************************
  ...
  Signature : 404db01d536291576d5d718de35e1c02e9b83e2b
  ***************************************************************************
*)
  ...
  tdialogservice.InputQuery('Key size',
    ...
    begin
      ...
      begin
        ...
        FKeySize := i;
        Key := TOlfCryptDecrypt.GenIDBKey(FKeySize);
...
begin
  ...
  OlfAboutDialog1.Description.Text :=
    'IDB keys Generator creates a randomly generated serie of integers as an array depending on the language you use.'
...
{$ENDIF}
TParams.InitDefaultFileNameV2('OlfSoftware', 'IDBKeysGen', false);
{$IF Defined(RELEASE)}
